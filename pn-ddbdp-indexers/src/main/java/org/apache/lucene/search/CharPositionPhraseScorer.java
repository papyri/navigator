...
public final class CharPositionPhraseScorer extends PhraseScorer {
    private int slop;
    ...
    public CharPositionPhraseScorer(Weight weight, TermPositions[] tps, int[] offsets, Similarity similarity,
                       int slop, byte[] norms) {
