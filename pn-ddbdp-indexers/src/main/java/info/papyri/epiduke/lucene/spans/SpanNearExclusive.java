...
public class SpanNearExclusive extends SpanQuery {
  ...
  public SpanNearExclusive(SpanQuery[] clauses, int slop, boolean inOrder) {
  ...
  public String toString(String field) {
    ...
    buffer.append("spanNearExclusive([");
    Iterator i = clauses.iterator();
    while (i.hasNext()) {
      SpanQuery clause = (SpanQuery)i.next();
  ...
  public Query rewrite(IndexReader reader) throws IOException {
      SpanNearExclusive clone = null;
    for (int i = 0 ; i < clauses.size(); i++) {
      SpanQuery c = (SpanQuery)clauses.get(i);
      SpanQuery query = (SpanQuery) c.rewrite(reader);
      if (query != c) {                     // clause rewrote: must clone
        if (clone == null)
          clone = (SpanNearExclusive) this.clone();
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SpanNearExclusive)) return false;

    final SpanNearExclusive spanNearQuery = (SpanNearExclusive) o;
