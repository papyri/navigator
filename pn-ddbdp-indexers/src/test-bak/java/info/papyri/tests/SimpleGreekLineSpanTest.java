...
public class SimpleGreekLineSpanTest extends TestCase {
	...
	private static final TermQuery L2W2 = new TermQuery(WORD_SPAN_TEMPLATE.createTerm("Σιδῶνος"));
	protected void setUp() throws Exception {
		super.setUp();
        TEIHandler main = new TEIHandler(true);
        main.addLineBreakTag("br");
        main.addLineBreakTag("td");
        main.addTextPattern("TEI.2/text/body/div");
		XMLReader digest = XMLReaderFactory.createXMLReader();
		digest.setContentHandler(main);
		digest.parse(new InputSource(EnglishLineSpanTest.class.getResourceAsStream("/xml/p.col.3.2.xml")));
