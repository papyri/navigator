...
//            System.out.print('.');
            Scorer s = null;
            SubstringSpanTermQuery xe = new SubstringSpanTermQuery(substrings[1],bigramsFL);
...
//            check.search(wlou);
//            System.out.print('.');
            SubstringSpanTermQuery kai2 = new SubstringSpanTermQuery(substrings[0],bigramsFL);
            SubstringSpanTermQuery upo2 = new SubstringSpanTermQuery(substrings[2],bigramsFL);
            SpanSequenceQuery kai_upo = new SpanSequenceQuery(new SpanQuery[]{kai2,upo2});
