...
public class StringSearchFacet extends Facet{
    ...
    public String generateWidget() {
        ...
        html.append("<input class=\"type\" class=\"type\" type=\"radio\" name=\"type\" value=\"substring\" id=\"substring\">");
        ...
        html.append("<input type=\"checkbox\" name=\"caps\" id=\"caps\" value=\"on\" checked>");    // will need to be changed once hooked in
        html.append("<label for=\"caps\" id=\"caps-label\">ignore capitalization</label><br/>");
        html.append("<input type=\"checkbox\" name=\"marks\" id=\"marks\" value=\"on\" checked>");  // will need to be changed once hooked in
