...
public class StringSearchFacetTest extends TestCase {
  ...
  public void testBuildSearchClauses() {
    ...
    try {
      ...
      // bracket-delimited terms resolves as subclauses
            /*
       * TODO: this functionality has been disabled. Do we still need a test?
  ...
  public void testAssignClauseRoles() {
    ...
    try {
      ...
      /*
       * TODO: subclauses enclosed by parentheses are no longer detected. Remove test?
    ...
    } catch (info.papyri.dispatch.browse.facet.customexceptions.InternalQueryException iqe) {
      fail("InternalQueryException thrown in test: " + iqe.getMessage());
    }
