...
if(CoreMetadataFields.SORTABLE_YES_VALUE.equals(doc.get(CoreMetadataFields.SORT_HAS_IMG))){
    ...
    //out.print("<td>" + doc.get(CoreMetadataFields.SORT_HAS_IMG) + "</td>");
        ...
        out.println("<td style=\"font-weight:bold;font-size:1.1em;\"><a href=\"text/" + id + "\" >" +  ddbName + "</a><a target=\"_new\" href=\"/idp_static/current/data/ddb/html" + staticFile + ".html\">[html]</a></td>");
        out.print("<td>");
