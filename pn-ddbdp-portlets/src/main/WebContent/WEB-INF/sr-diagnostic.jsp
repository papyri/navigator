<%@ page language="java" pageEncoding="UTF-8" session="false" contentType="text/xml; charset=UTF-8" import="java.io.IOException,java.util.*,info.papyri.ddbdp.servlet.*" %><sru:searchRetrieveResponse
