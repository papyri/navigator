 ...
 */
public class RdqlOptionParser extends CmdLineParser {
   ...
   */
  public final static Option RDQL_CONFIG =
      new CmdLineParser.Option.StringOption('i', "rdqlconfig");
  ...
  /**
   * the command line arguments passed to the rdql interpreter
   */
   ...
   */
  public RdqlOptionParser(String[] args) {
  ...
  /**
   * Sets the command line arguments passed to the rdql interpreter.
   *
  ...
  /**
   * Returns the command line arguments passed to the rdql interpreter.
   *
   * @return the command line arguments passed to the rdql interpreter
   */
