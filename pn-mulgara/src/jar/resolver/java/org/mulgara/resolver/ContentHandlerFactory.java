...
/**
 * Constructs {@link ContentHandler} instances, given a classname.
 *
 * @created 2004-10-07
...
abstract class ContentHandlerFactory
{
  ...
  private static final Logger logger =
    Logger.getLogger(ContentHandlerFactory.class.getName());
   ...
   */
  static ContentHandler newContentHandler(String className)
  {
    ...
    try {
      ...
      return (ContentHandler) contentHandlerClass.getConstructor(new Class[] {})
