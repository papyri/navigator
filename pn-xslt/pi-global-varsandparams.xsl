...
<!-- $Id: global-varsandparams.xsl 2090 2013-10-24 15:23:22Z gabrielbodard $ -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">

            <!-- Location of file defining the parameters and variables -->
            <xsl:variable name="param-file">
                        <xsl:text>pi-global-parameters.xml</xsl:text>
            </xsl:variable>
            ...
            <xsl:param name="hgv-gloss">
                        <xsl:text>/srv/data/papyri.info/idp.data/HGV_trans_EpiDoc/glossary.xml</xsl:text>
            </xsl:param>
