// $ANTLR 2.7.7 (20060930): "beta4.g" -> "BetaLexer.java"$
...
inputState.guessing--;
	...
	public final void mNONBASE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = NONBASE;
		int _saveIndex;
	...
	private static final long[] mk_tokenSet_0() {
		long[] data = new long[3216];
		data[172]=-16384L;
		for (int i = 173; i<=192; i++) { data[i]=-1L; }
		data[196]=-281474976710656L;
		data[197]=-1L;
		data[198]=4294967295L;
		for (int i = 200; i<=1022; i++) { data[i]=-1L; }
		data[1023]=144115188075855871L;
		return data;
	}
	...
	private static final long[] mk_tokenSet_1() {
		...
		data[2]=-4294967297L;
		for (int i = 3; i<=171; i++) { data[i]=-1L; }
		data[172]=16383L;
		for (int i = 193; i<=195; i++) { data[i]=-1L; }
		data[196]=281474976710655L;
		data[198]=-4294967296L;
		data[199]=-1L;
		data[1023]=9079256848778919936L;
		return data;
	}
	public static final BitSet _tokenSet_1 = new BitSet(mk_tokenSet_1());
	private static final long[] mk_tokenSet_2() {
		long[] data = new long[1025];
		data[0]=2305995841329954816L;
		data[1]=1152921504875282432L;
		return data;
	}
