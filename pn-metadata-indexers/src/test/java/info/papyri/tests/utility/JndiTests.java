...
public class JndiTests extends TestCase {
    ...
    /**
     * Below is a dead test, for now.
     * One day I'd like to explore using naming contexts (and possibly JNDI) more fully for citation matching
    **/
    public void testJNDIPublicationBinding() throws NamingException {
        ...
        //root.bind(omich,new InitialContext());
    }
}
