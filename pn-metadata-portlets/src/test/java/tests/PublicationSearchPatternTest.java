...
public class PublicationSearchPatternTest extends TestCase {
    ...
    public void testNormalNoVolume(){
        String actual = XREFSearchPortlet.normalizePub("p.oxy.", null, "744");
        String expected = "P.Oxy. * 744";
        assertEquals("E: " + expected + " A: " + actual,expected,actual);
    }
    
    public void testNormalNoDocument(){
        String actual = XREFSearchPortlet.normalizePub("p.col.", "III", null);
        String expected = "P.Col. III *";
        assertEquals("E: " + expected + " A: " + actual,expected,actual);
    }
    public void testNormalNoVolumeDocument(){
        String actual = XREFSearchPortlet.normalizePub("p.cair.zen.", null, null);
        String expected = "P.Cair. Zen. *";
        assertEquals("E: " + expected + " A: " + actual,expected,actual);
    }
    public void testNormalArabicVolume(){
        String actual = XREFSearchPortlet.normalizePub("p.col.", "3", "2");
