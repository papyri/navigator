<%@page language="java" session="false" contentType="text/html" import="info.papyri.navigator.portlet.*" pageEncoding="UTF-8"%>
...
%>                  <tfoot>
                      ...
                      <tr>
                      <td class="rowheader" align="left" colspan="10">
                        <div style="float:right">
                        <form action=""><input type="button" class="pn-button" onclick="document.getElementById('pn-display-mode').value='search';document.getElementById('ui').submit();return false;" value="Revise Search" />
